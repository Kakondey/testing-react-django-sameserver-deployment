...
SECRET_KEY = 'django-insecure-&cpb4t9w39ovn2^kq+1^$^g#9-sb!he&9ox8%p%6)%xt59l5lv'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', '13.233.201.60']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, '../../../../frontend/frontend-workdir/testing-frontend-deployement/testing-frontend-deployement')] if PROD else [os.path.join(BASE_DIR, '../frontend')],
